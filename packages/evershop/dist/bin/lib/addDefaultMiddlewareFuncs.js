    ...
    app.use(async (request, response, next)=>{
        ...
        if (!route || !isBuildRequired(route)) {
            ...
            if (!app.locals.webpackCompiler) {
                app.locals.webpackCompiler = webpack(createConfigClient(adminTailwindConfig, frontStoreTailwindConfig));
            }
            const { webpackCompiler } = app.locals;
            let middlewareFunc;
            if (!app.locals.webpackMiddleware) {
                middlewareFunc = app.locals.webpackMiddleware = middleware(webpackCompiler, {
