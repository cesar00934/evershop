...
export default function SlideshowSetting({ slideshowWidget }) {
    ...
    return /*#__PURE__*/ React.createElement("div", {
    ...
    }, "Slideshow Settings"), /*#__PURE__*/ React.createElement("div", {
        ...
        htmlFor: "autoplay",
        className: "text-sm"
    }, "Autoplay Slides")), Boolean(currentAutoplay) && /*#__PURE__*/ React.createElement(InputField, {
        type: "number",
        ...
        className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4"
            ...
            className: `relative border rounded overflow-hidden cursor-pointer ${activeSlideIndex === index ? 'ring-2 ring-blue-500' : ''}`
        }, /*#__PURE__*/ React.createElement("div", {
            ...
            className: "p-2 bg-white border-t"
            ...
            disabled: index === 0,
            className: `mr-1 p-1 rounded ${index === 0 ? 'text-gray-300' : 'text-gray-500 hover:bg-gray-100'}`
            ...
            className: `mr-1 p-1 rounded ${index === fields.length - 1 ? 'text-gray-300' : 'text-gray-500 hover:bg-gray-100'}`
        }, /*#__PURE__*/ React.createElement("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            width: "16",
            height: "16",
        ...
        className: "absolute inset-0 bg-black bg-opacity-20 flex flex-col items-center justify-center p-4 text-center"
