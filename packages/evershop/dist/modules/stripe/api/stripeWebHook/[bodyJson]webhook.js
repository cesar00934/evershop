            ...
            case 'payment_intent.succeeded':
                {
                    ...
                    if (!transaction) {
                        ...
                        // Add an activity log
                        await addOrderActivityLog(order.order_id, `Customer paid by using Stripe. Transaction ID: ${paymentIntent.id}`, false, connection);
            ...
            case 'payment_intent.amount_capturable_updated':
                {
                    ...
                    if (!transaction) {
                        ...
                        // Add an activity log
                        await addOrderActivityLog(order.order_id, `Customer authorized by using Stripe. Transaction ID: ${paymentIntent.id}`, false, connection);
                        // Emit event to add order placed event
                        await emit('order_placed', {
                            ...order
                        });
