...
function TableContent({ loading = false, noHeader = false, onSort, currentSort, emptyMessage, className }) {
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(Area, {
        ...
        className: className
    }, !noHeader && /*#__PURE__*/ React.createElement("thead", null, /*#__PURE__*/ React.createElement("tr", null, columns.filter((col)=>!col.isRemoved).map((col)=>/*#__PURE__*/ React.createElement("th", {
            key: col.key,
        ...
        }, currentSort.direction === 'asc' ? '↑' : '↓')))))), /*#__PURE__*/ React.createElement("tbody", {
        className: "divide-y divide-gray-200"
    }, tableData.length === 0 ? /*#__PURE__*/ React.createElement("tr", null, /*#__PURE__*/ React.createElement("td", {
        colSpan: columns.filter((col)=>!col.isRemoved).length
    }, emptyMessage)) : tableData.map((row, rowIndex)=>/*#__PURE__*/ React.createElement("tr", {
            key: rowIndex
        }, columns.filter((col)=>!col.isRemoved).map((col)=>/*#__PURE__*/ React.createElement("td", {
                key: col.key,
