...
export function PasswordField({ name, label, placeholder, className = '', wrapperClassName, required = false, disabled = false, minLength = 6, showToggle = false, error, helperText, validation, onChange, prefixIcon, suffixIcon, ...props }) {
    ...
    }, prefixIcon), renderInput(), (suffixIcon || showToggle) && /*#__PURE__*/ React.createElement("div", {
        className: "suffix absolute right-3 z-10 flex items-center justify-center"
    }, suffixIcon || renderToggleButton())) : /*#__PURE__*/ React.createElement("div", {
        className: "relative"
    }, renderInput(), showToggle && /*#__PURE__*/ React.createElement("button", {
        type: "button",
        className: "absolute inset-y-0 right-0 pr-3 flex items-center",
        onClick: ()=>setShowPassword(!showPassword),
        tabIndex: -1
    }, renderToggleButton())), fieldError && /*#__PURE__*/ React.createElement("p", {
        id: `${fieldId}-error`,
