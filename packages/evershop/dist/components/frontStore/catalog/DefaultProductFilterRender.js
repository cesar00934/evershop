...
export const DefaultProductFilterRender = ({ renderProps, className = '', title = _('Filter Products'), showFilterSummary = true })=>{
    ...
    })), /*#__PURE__*/ React.createElement("span", null, _('Filters')), activeFilterCount > 0 && /*#__PURE__*/ React.createElement("span", {
        className: "bg-blue-500 text-white text-xs px-2 py-1 rounded-full"
    }, activeFilterCount)), isMobileFilterOpen && /*#__PURE__*/ React.createElement("div", {
        className: "md:hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-end"
    }, /*#__PURE__*/ React.createElement("div", {
        className: "w-full bg-white rounded-t-lg max-h-[90vh] flex flex-col"
    }, /*#__PURE__*/ React.createElement("div", {
        className: "flex items-center justify-between p-4 border-b"
    }, /*#__PURE__*/ React.createElement("h3", {
        className: "font-bold text-lg"
    }, _('Filters')), /*#__PURE__*/ React.createElement("button", {
    ...
    }, title, activeFilterCount > 0 && /*#__PURE__*/ React.createElement("span", {
        className: "ml-2 bg-blue-100 text-blue-800 text-sm px-2 py-1 rounded-full"
    }, activeFilterCount), isLoading && /*#__PURE__*/ React.createElement("div", {
