...
export const DefaultPaginationRenderer = ({ renderProps, className = '', showInfo = false })=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...
        className: "pagination-info text-center text-gray-600 mb-4"
    }, getDisplayText()), /*#__PURE__*/ React.createElement("ul", {
        className: "pagination flex justify-center space-x-3"
    }, hasPrev && /*#__PURE__*/ React.createElement("li", {
        ...
        clipRule: "evenodd"
    })))), getPageNumbers().map((p)=>/*#__PURE__*/ React.createElement("li", {
            key: p,
            className: `page-item self-center ${isCurrentPage(p) ? 'current' : ''}`
        }, /*#__PURE__*/ React.createElement("button", {
            type: "button",
            className: "link-button page-link flex justify-center items-center",
            onClick: ()=>goToPage(p),
            disabled: isLoading || isCurrentPage(p)
        }, isCurrentPage(p) ? /*#__PURE__*/ React.createElement("strong", null, p) : p))), hasNext && /*#__PURE__*/ React.createElement("li", {
