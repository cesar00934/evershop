...
export function Payment() {
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: "checkout__payment space-y-6"
    }, /*#__PURE__*/ React.createElement("h3", null, _('Payment')), /*#__PURE__*/ React.createElement(BillingAddress, {
        billingAddress: billingAddress,
        addBillingAddress: addBillingAddress,
        addingBillingAddress: addingBillingAddress,
        noShippingRequired: noShippingRequired
    }), (billingAddress || noShippingRequired === false) && /*#__PURE__*/ React.createElement(PaymentMethods, {
